...
class MainWindow(tk.Tk):
    ...
    def __init__(self, title):
        ...
        # Define colors
        myActiveTabBackgroundColor = "black"
        myActiveTabForegroundColor = "black"
        myTabBackgroundColor = "black"
        myTabForegroundColor = "black"
        myTabBarColor = "white"
        # Define style
        ...
        # Coloring the menu
        self.filemenu.configure(background='white', foreground='black',
                                activebackground='#0080ff',
                                activeforeground='white')
        self.editmenu.configure(background='white', foreground='black',
                                activebackground='#0080ff',
                                activeforeground='white')
        self.helpmenu.configure(background='white', foreground='black',
                                activebackground='#0080ff',
                                activeforeground='white')
