...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.tab2 = tk.Frame(self.notebook, background='white')
        self.other = tk.Frame(self.notebook, background='white')
        self.tab1.pack()
        self.tab2.pack()
        self.other.pack()
        ...
        button.configure(bg="white", fg='black', activebackground='#0080ff', activeforeground='white')
        button.pack(side=tk.RIGHT, padx=5, pady=5)
    # ------------------------------- tab1 ---------------------------------

    def aes_encryption_tab(self):
        self.input3 = tk.LabelFrame(self.tab1, bg="white", fg='black', text=" Image to hide text in ")
        ...
        button2.configure(bg="white", fg='black', activebackground='#0080ff', activeforeground='white')
        
        self.input = tk.LabelFrame(self.tab1, text=" Text to hide ",  background="white", foreground='black')
        ...
        button21.configure(bg="white", fg='black', activebackground='#0080ff', activeforeground='white')
        
        self.input.pack(expand=1, fill="both", padx=5, pady=5)

        self.input1 = tk.LabelFrame(self.tab1, bg="white", fg='black', text=" Hide text status ")
        self.status_message = tk.StringVar()
        self.status_message.set('\n No text is hidden yet\n')
        
        textwidget = tk.Label(self.input1, textvariable=self.status_message, bg='white', fg="black", wraplength=590)
    ...
    def aes_decryption_tab(self):
        self.input22 = tk.LabelFrame(self.tab2, bg="white", fg='black', text=" Image with hidden text ")
        ...
        button22.configure(background="white", foreground='black', activebackground='white', activeforeground='black')
        
        self.input31 = tk.LabelFrame(self.tab2, background="white", foreground='black', text=" Image to hide text in ")
        self.input31.pack(expand=1, padx=5, pady=5)

        self.input23 = tk.LabelFrame(self.tab2, bg="white", fg='black', text=" Extracted text ")
        self.input23.pack(expand=1, fill="both", padx=5, pady=5)
        
        self.extracted_message = tk.StringVar()
        self.extracted_message.set('\nExtracted text\n')
        
        textwidget3 = tk.Label(self.input23, textvariable=self.extracted_message, background='white', foreground="black")
        ...
        button12.configure(bg="white", fg='black', activebackground='#0080ff', activeforeground='white')
    # ------------------------------- logic --------------------------------
    def dummy(self):
        pass
